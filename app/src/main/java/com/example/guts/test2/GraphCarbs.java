...
public class GraphCarbs extends AppCompatActivity {

    private XYPlot plot;
    static final String TAG = "GraphCarbs";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_graph_carbs);
        ...
        try {
            ...
            Log.e("22", getIntent().getStringExtra("DATE"));
            ArrayList<Double[]> temp =  dbHandlerGrim.getCountCarbohydrates(db, "month", getIntent().getStringExtra("DATE"));
