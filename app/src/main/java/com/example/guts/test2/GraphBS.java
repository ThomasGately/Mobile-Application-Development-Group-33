...
public class GraphBS extends AppCompatActivity {

    private XYPlot plot;
    static final String TAG = "GraphBS";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_graph_bs);
        ...
        try {
            ...
            ArrayList<Double[]> temp =  dbHandlerGrim.getAvgBloodSugar(db, "month", getIntent().getStringExtra("DATE"));
